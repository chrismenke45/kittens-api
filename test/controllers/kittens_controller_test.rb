...
class KittensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kitten" do
    assert_difference("Kitten.count") do
      post kittens_url, params: { kitten: { age: @kitten.age, cuteness: @kitten.cuteness, friendliness: @kitten.friendliness, name: @kitten.name } }
    end
  ...
  test "should update kitten" do
    patch kitten_url(@kitten), params: { kitten: { age: @kitten.age, cuteness: @kitten.cuteness, friendliness: @kitten.friendliness, name: @kitten.name } }
